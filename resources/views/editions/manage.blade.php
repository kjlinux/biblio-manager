...
@section('layout')
                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-center">
                            <div class="d-flex align-items-center align-self-start">
                                <h1 class="mb-0">GESTION DES EDITIONS</h1>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Liste des éditions</h4>
                    <button type="button" class="btn btn-success btn-lg btn-block" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop">
                        <i class="mdi mdi-plus"></i>Enregistrer une édition</button>
                        ...
                        <table id="table" class="table table-striped" data-toggle="table" data-pagination="true"
                            ...
                            <tbody>
                                @foreach ($editions as $edition)
                                    <tr>
                                        <td>{{ $edition['id'] }}</td>
                                        <td>{{ $edition['titre_ed'] }}</td>
                                        <td>{{ $edition['adresse_ed'] }}</td>
                                        <td> </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Enregistrement d'une édition</h1>
...
@push('script')
    <script>
        ...
        function edit(id) {
            $.ajax({
                method: 'GET',
                url: '/editions/' + id + '/edit',
                success: function(response) {
                    var edition = response.edition;

                    $('#id_edit').val(edition.id);
                    $('#edit input[name="titre_e"]').val(edition.titre_ed);
                    $('#edit input[name="adresse_e"]').val(edition.adresse_ed);
